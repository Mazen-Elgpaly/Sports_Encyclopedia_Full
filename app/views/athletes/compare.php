...
<script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        function updateAthleteData(slot, id) {
            ...
            if (!id) {
                ...
                setTimeout(() => {
                    ...
                    if (profile) {
                        ...
                        const n = profile.querySelector(".name");
                        if (n) n.innerHTML = "";
            ...
            if (profile) {
                ...
                if (athlete.image) {
                    ...
                    img.onload = () => {
                        ...
                        avatarDiv.classList.add("visible");
                    };
            ...
            if (chartInstances[slot]) {
                chartInstances[slot].destroy();
                chartInstances[slot] = null;
            }
        ...
        function refreshAchievements() {
            ...
            active.forEach(a => {
                (a.stats || []).forEach(s => {
                    if (!statKeys.includes(s.label)) statKeys.push(s.label);
                });
            });
            ...
            statKeys.forEach(key => {
                const vals = active.map(a => {
                    const s = (a.stats || []).find(x => x.label === key);
