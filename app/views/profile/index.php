...
<main class="main">
    <div class="profile" style="max-width:900px;">
        ...
        <form method="POST" action="<?= BASE_URL ?>/profile/delete-avatar" enctype="multipart/form-data" onsubmit="return confirm('Are you sure you want to delete your avatar?');" style="display: contents;">
